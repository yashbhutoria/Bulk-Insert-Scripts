CREATE TABLE [dbo].[Current Period](
	...
	[Total Days Lost] [varchar](50) NULL,
	[Avg Days Lost per Employee] [varchar](50) NULL,
	[Planned Not Hired - Strategy 2 0 (Positions)] [varchar](50) NULL,
	[Planned Not Hired Amount - Strategy 2 0 Positions (USD)] [varchar](50) NULL,
	[Total Days Lost- Strategy 2 0 Positions] [varchar](50) NULL,
	[Avg Days Lost per Employee- Strategy 2 0 Position] [varchar](50) NULL,
	[Planned Not Hired Position - All Position] [varchar](50) NULL,
	[Planned Not Hired Amount - All Position] [varchar](50) NULL,
